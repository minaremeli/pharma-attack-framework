...
class ModelConfig:
    def __init__(self):
        ...
        parser.add_argument("--rounds", help="How many rounds should the model train for.", type=int, default=40)
...
class TrunkActivationAttackConfig:
    def __init__(self):
        parser = argparse.ArgumentParser(description="Arguments for the Trunk Activation Attack.")
